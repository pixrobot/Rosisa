...
if 'password' in password:
    ...
    print("NEW! To scan an IP Address for open ports just type: Scan an IP Address for open ports without showing closed ports or Scan an IP Address for open ports showing closed ports")
